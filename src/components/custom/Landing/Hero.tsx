...
const Hero = () => {
  return (
    <>
      <div className="flex justify-center w-full h-auto relative overflow-hidden p-5 ">
        <img
        ...
        <div className="flex flex-col lg:flex-row justify-between w-full lg:w-[90%]  p-5 gap-10">
          <div className="w-full flex justify-center lg:w-[50%] ">
            {/* <h1 className="text-4xl text-left md:text-5xl lg:text-7xl font-bold text-nowrap">
            ...
            <p className="text-lg my-4 text-left font-light text-black-100">
              Where Your Future Begins: Unlock Guaranteed Career <br /> Success
              With The Best Guidance
            </p>
            <Learner />
            <div className="flex items-center  gap-2 my-4 ">
              <Button text="Enroll Now" classname="py-3 px-4 lg:px-8 lg:py-3" />
            ...
            <div className="flex flex-col">
              <h1 className="text-4xl md:text-5xl lg:text-7xl font-bold text-nowrap">
                The <span className="text-green-tertiary">Ultimate</span> <br />
                <span className="text-green-tertiary">Launchpad</span> For{" "}
                <br />
                Your <span className="text-green-tertiary">Career!</span>
              </h1>
